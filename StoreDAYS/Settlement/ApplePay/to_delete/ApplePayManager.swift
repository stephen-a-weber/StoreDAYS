...
extension ApplePayManager: PKPaymentAuthorizationViewControllerDelegate {
    ...
    //
      private func paymentAuthorizationController(_ controller: PKPaymentAuthorizationController, didSelectShippingContact contact: PKContact, handler completion: @escaping (PKPaymentRequestShippingContactUpdate) -> Void) {
