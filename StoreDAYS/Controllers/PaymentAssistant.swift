//
//  PaymentAssistant.swift
//  StoreDAYS
//
//  Created by Young Ju on 4/1/22.
//

// Note: The code below was taken from the sample app from https://developer.apple.com/documentation/passkit/apple_pay/offering_apple_pay_in_your_app - excluded part of the code for watchOS.

import PassKit

typealias PaymentCompletionHandler = (Bool) -> Void

class PaymentAssistant: NSObject {
    ...
    func startPayment(completion: @escaping PaymentCompletionHandler) {
        ...
        let ticket = PKPaymentSummaryItem(label: "Pet", amount: NSDecimalNumber(string: "9.99"), type: .final)
...
//        paymentRequest.merchantIdentifier = Configuration.Merchant.identifier
        ...
        paymentRequest.supportedNetworks = PaymentAssistant.supportedNetworks
...
extension PaymentAssistant: PKPaymentAuthorizationControllerDelegate {
